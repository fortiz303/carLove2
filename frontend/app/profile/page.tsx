  ...
  return (
    <PrimaryLayout>
      ...
      <div className="relative z-20 -mt-20 px-6">
        {/* Profile Image Container with border ring */}
        <div className="relative w-32 h-32 md:w-44 md:h-44 rounded-full border-[6px] border-white shadow-lg bg-white overflow-visible">
          {/* Avatar Component */}
          ...
          {/* Camera Icon Button */}
          <button className="absolute bottom-0 right-0 w-8 h-8 md:w-10 md:h-10 bg-white border border-gray-300 rounded-full flex items-center justify-center shadow-md hover:scale-105 transition">
            <Camera className="w-4 h-4 md:w-5 md:h-5 text-teal-700" />
          </button>
        </div>
      </div>
